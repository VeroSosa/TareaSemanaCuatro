    ...
    public void mandarCorreo(View view){
        ...
        session = Session.getDefaultInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication(){
                return new PasswordAuthentication("verososa889@gmail.com", "12345");
            }
        });
    ...
    class RetrieveFeedTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... params) {
            try{
                ...
                message.setRecipient(Message.RecipientType.TO, new InternetAddress("verososa889@gmail.com"));
                message.setRecipients(Message.RecipientType.CC, InternetAddress.parse(rec));
                message.setSubject("Semana 4");
